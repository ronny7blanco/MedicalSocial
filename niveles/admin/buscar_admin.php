...
<title>Buscar Administradores | Medical Social</title>
...
<h2>LISTA DE ADMINISTRADORES</h2>
        ...
        <?php
        try{
            $sentencia = $conn->query("SELECT * FROM admin");
           ...
           ?>
            ...
            <tr>
                   ...
                   <td><?=$row["apellido"];?></td>
                   <td><?=$row["nickname"];?></td>
                   <!--<td><a href="eliminar_doctor.php?id=<?php echo $ver["id"];?>">Eliminar</a>&nbsp; 
                    <a href="../admin/editar_doc.php?id=<?php echo $ver["id"];?>">Editar</a></td>-->
            </tr>
                <?php
            }
            ?>
